            ...
            <div class="row">
                ...
                <div class="col s12 m8 l8">
                    ...
                    <div class="blogs mb-30">
                        <div class="card">
                            <div class="card-image">
                                <img src="{{asset('/frontends/img/selfie.jpg')}}" alt="Image">
                    ...
                    <div class="blogs mb-30">
                        <div class="card">
                            <div class="card-image">
                                <img src="{{asset('/frontends/img/blog4.jpg')}}" alt="Image">
                                <a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
                                    <i class="icofont icofont-camera-alt"></i>
                                </a>
                            </div>
                    ...
                    <div class="blogs mb-30">
                        <div class="card">
                            <div class="card-image">
                                <img src="{{asset('/frontends/img/travel2.jpg')}}" alt="Image">
                                <a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
                                    <i class="icofont icofont-camera-alt"></i>
                                </a>
                            </div>
                    ...
                    <div class="blogs mb-30">
                        <div class="card">
                            <div class="card-image">
                                <img src="{{asset('/Frontends/img/fashion2.jpg ')}}" alt="Image">
                                <a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
                                    <i class="icofont icofont-camera-alt"></i>
                                </a>
                            </div>
                        ...
                        <div class="sidebar-posts">
                            <div class="card">
                                <div class="card-image mb-10">
                                    <img src="{{asset('/frontends/img/blog3.jpg')}}" alt="Image">
                            ...
                            <div class="card">
                                <div class="card-image mb-10">
                                    <img src="{{asset('/frontends/img/blog1.jpg')}}" alt="Image">
                                    <span class="effect"></span>
                                </div>
                                <!-- /.card-image -->
                                <div class="card-content w100dt">
                            ...
                            <div class="card">
                                <div class="card-image mb-10">
                                    <img src="{{asset('/frontends/img/blog2.jpg')}}" alt="Image">
                                    <span class="effect"></span>
                                </div>
                                <!-- /.card-image -->
                                <div class="card-content w100dt">
                    ...
                    <div class="top-post w100dt mb-30">
                        ...
                        <div id="test-swipe-1" class="tab-contant most-view">
                            ...
                            <div class="sidebar-posts">
                                <div class="card">
                                    <div class="card-image mb-10">
                                        <img src="{{asset('/frontends/img/fashion.jpg')}}" alt="Image">
                                        <span class="effect"></span>
                                    </div>
                                    <!-- /.card-image -->
                                    <div class="card-content w100dt">
                                ...
                                <div class="hot-post w100dt mb-10">
                                    <div class="hot-post-image">
                                        <img src="{{asset('/frontends/img/img3.jpg')}}" alt="Image">
                                        <span class="effect"></span>
                                    </div>
                                    <!-- /.hot-post-image -->
                                    <div class="hot-post-stacked">
                                        ...
                                        <a href="single-blog.html" class="sm-name mb-10">Trud Exercitation EllaMcop
                                            Saboris</a>
                                ...
                                <div class="hot-post w100dt mb-10">
                                    <div class="hot-post-image">
                                        <img src="{{asset('/frontends/img/img2.jpg')}}" alt="Image">
                                        <span class="effect"></span>
                                    </div>
                                    <!-- /.hot-post-image -->
                                    <div class="hot-post-stacked">
                                ...
                                <div class="hot-post w100dt mb-10">
                                    <div class="hot-post-image">
                                        <img src="{{asset('/frontends/img/img1.jpg')}}" alt="Image">
                                        <span class="effect"></span>
                                    </div>
                                    <!-- /.hot-post-image -->
                                    <div class="hot-post-stacked">
                        ...
                        <div id="test-swipe-3" class="tab-contant Comments-post">
                            ...
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="{{asset('/frontends/img/img1.jpg')}}" alt="Image" class="circle responsive-img">
                            ...
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="{{asset('/frontends/img/img2.jpg')}}" alt="Image" class="circle responsive-img">
                                        <!-- notice the "circle" class -->
                                    </div>
                                    <div class="col s9">
											<span class="black-text">
                            ...
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="{{asset('/frontends/img/img3.jpg')}}" alt="Image" class="circle responsive-img">
                                        <!-- notice the "circle" class -->
                                    </div>
                                    <div class="col s9">
											<span class="black-text">
