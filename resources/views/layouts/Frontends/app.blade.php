@include('layouts.Frontends.partial.header')
<!-- /#header-section -->
<!-- ==================== header-section End ==================== -->
        ...
        <div class="slider">
            <ul class="slides">
                <li class="slider-item">
                    <img src="{{asset('/Frontends/img/travel.jpg')}}" alt="Image">
                ...
                <li class="slider-item">
                    <img src="{{asset('/Frontends/img/lifestyle.jpg')}}" alt="Image">
    ...
    <div class="container">
        ...
        <div class="owl-carousel small-carousel owl-theme">
            ...
            <div class="item">
                <div class="card horizontal">
                    <div class="card-image">
                        <img src="{{asset('/Frontends/img/img1.jpg')}}g" alt="Image">
                        <span class="effect"></span>
                    </div>
                    <!-- /.card-image -->
                    <div class="card-stacked">
...
@include('layouts.Frontends.partial.footer')
